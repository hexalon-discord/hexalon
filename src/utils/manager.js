const { EmbedBuilder, TimestampStyles, MessageComponentInteraction, InteractionType, Embed, Events, ButtonBuilder, ButtonStyle, ActionRowBuilder, UserContextMenuCommandInteraction, ModalBuilder, TextInputBuilder, TextInputStyle } = require("discord.js");
const Guilds = require('../models/Guilds');
const { Timestamp, MongoServerError } = require("mongodb");
const config = require("../config/config");
const { ButtonInteraction } = require("discord.js");

module.exports = class Manager {

    static help(client, guild, moderator, channel, cmds, slashCommand) {
        ...
        const helpEmbed = new EmbedBuilder()
            ...
            .setDescription(`*<@${moderator.id}> here is some information about my commands!*\n\n${categories[0]}`)
        ...
        if (!slashCommand) {
            ...
            .then((msg) => {
                ...
                const filter = (interaction) => {
                    return interaction.isButton() && interaction.message.id === msg.id && interaction.user.id === moderator.id;
                };
                ...
                collector.on('collect', (interaction) => {
                    ...
                    helpEmbed.setDescription(`*<@${moderator.id}> here is some information about my commands!*\n\n${categories[currentPage]}`);
            ...
            slashCommand.reply({ embeds: [helpEmbed], components: [row],  ephemeral: true, })
            .then((msg) => {
                const filter = (interaction) => {
                    return interaction.isButton() && interaction.message.id === msg.id && interaction.user.id === moderator.id;
                };
